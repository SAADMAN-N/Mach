...
const BillingPage = () => {
    ...
    return (
        <div>
            ...
            <p className="text-sm text-gray-500">You currently have {credits?.credits} credits.</p>
            ...
            <div className="h-4"></div>
            <Button onClick={() => { createCheckoutSession(creditsToBuyAmount) }}>Buy {creditsToBuyAmount} for ${price}</Button>
        </div>
